...
/**
 The `Debouncer` class delays the execution of a function by a specified time interval. If the function is called again before the time interval has elapsed, the delay is reset and the function is executed again after the time interval has elapsed since the last call.
 */
class Debouncer {
    ...
    /**
     Initializes a new `Debouncer` with the specified delay.
...
/**
 The `DebouncerManager` class manages a `Debouncer` and provides a way to set a callback that is debounced.
